<form action="/viewvehicles" method="post" class="vehicle-table-form">
            ...
            <c:forEach var="vehicle" items="${vehicles}">
                <tr>
                    ...
                    <td data-label="Actions" class="actions">
                        <a href="update-vehicle.jsp?plate=${vehicle.plateNumber}" class="btn-update">
                        ...
                        <a href="delete-vehicle.jsp?plate=${vehicle.plateNumber}" class="btn-delete">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
